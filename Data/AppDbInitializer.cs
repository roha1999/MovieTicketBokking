...
namespace eCommerceApp.Data
{
    ...
    {
        //object thet provides the mechanisms to configure an application's request pipline
        public static void Seed(IApplicationBuilder applicationBuilder)
        {
            using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
            {
                //Going to create a reference to the AppDbContext file (used to send data to the databse or get data from the databse)
                ...
                if (!context.Actor.Any())
                {
                    context.Actor.AddRange(new List<Actor>()
                    {
                        ...
                        {
                            FullName = "Actor 5",
                            Bio = "This is the Bio of the fith actor",
                            ProfilePictureURL = "http://dotnethow.net/images/actors/actor-5.jpeg"
                        },new Actor()
                        {
                            FullName = "Actor 6",
                            Bio = "This is the Bio of the sixth actor",
                            ProfilePictureURL = "http://dotnethow.net/images/actors/actor-3.jpeg"
                        }
                    });
                    context.SaveChanges();
                ...
                //Relation between the Actors & Movies
